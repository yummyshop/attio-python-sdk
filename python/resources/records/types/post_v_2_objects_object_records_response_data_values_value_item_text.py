...
class PostV2ObjectsObjectRecordsResponseDataValuesValueItemText(pydantic.BaseModel):
    ...
    created_by_actor: PostV2ObjectsObjectRecordsResponseDataValuesValueItemTextCreatedByActor = pydantic.Field(
