...
class GetV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemPersonalName(pydantic.BaseModel):
    ...
    created_by_actor: GetV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemPersonalNameCreatedByActor = (
