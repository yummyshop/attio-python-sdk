...
class PutV2ListsListEntriesResponseDataEntryValuesValueItemNumber(pydantic.BaseModel):
    ...
    created_by_actor: PutV2ListsListEntriesResponseDataEntryValuesValueItemNumberCreatedByActor = pydantic.Field(
