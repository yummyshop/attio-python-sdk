...
class GetV2ObjectsObjectRecordsRecordIdAttributesAttributeValuesResponseDataItemRecordReference(pydantic.BaseModel):
    ...
    created_by_actor: GetV2ObjectsObjectRecordsRecordIdAttributesAttributeValuesResponseDataItemRecordReferenceCreatedByActor = pydantic.Field(
