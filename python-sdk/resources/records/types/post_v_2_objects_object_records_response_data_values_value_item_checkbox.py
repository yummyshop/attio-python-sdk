...
class PostV2ObjectsObjectRecordsResponseDataValuesValueItemCheckbox(pydantic.BaseModel):
    ...
    created_by_actor: PostV2ObjectsObjectRecordsResponseDataValuesValueItemCheckboxCreatedByActor = pydantic.Field(
