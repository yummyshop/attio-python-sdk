...
class PostV2ListsListEntriesQueryResponseDataItemEntryValuesValueItemEmailAddress(pydantic.BaseModel):
    ...
    created_by_actor: PostV2ListsListEntriesQueryResponseDataItemEntryValuesValueItemEmailAddressCreatedByActor = (
