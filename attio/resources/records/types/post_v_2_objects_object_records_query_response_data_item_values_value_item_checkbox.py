...
class PostV2ObjectsObjectRecordsQueryResponseDataItemValuesValueItemCheckbox(pydantic.BaseModel):
    ...
    created_by_actor: PostV2ObjectsObjectRecordsQueryResponseDataItemValuesValueItemCheckboxCreatedByActor = (
