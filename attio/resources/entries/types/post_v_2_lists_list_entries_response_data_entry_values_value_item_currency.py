...
class PostV2ListsListEntriesResponseDataEntryValuesValueItemCurrency(pydantic.BaseModel):
    ...
    created_by_actor: PostV2ListsListEntriesResponseDataEntryValuesValueItemCurrencyCreatedByActor = pydantic.Field(
