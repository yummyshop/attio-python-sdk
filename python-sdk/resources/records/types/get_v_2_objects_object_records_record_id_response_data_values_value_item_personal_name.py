...
class GetV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemPersonalName(pydantic.BaseModel):
    ...
    created_by_actor: GetV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemPersonalNameCreatedByActor = (
