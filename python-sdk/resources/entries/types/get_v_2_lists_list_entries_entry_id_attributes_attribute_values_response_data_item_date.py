...
class GetV2ListsListEntriesEntryIdAttributesAttributeValuesResponseDataItemDate(pydantic.BaseModel):
    ...
    created_by_actor: GetV2ListsListEntriesEntryIdAttributesAttributeValuesResponseDataItemDateCreatedByActor = (
