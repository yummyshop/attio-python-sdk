...
class GetV2ObjectsObjectRecordsRecordIdAttributesAttributeValuesResponseDataItemTimestamp(pydantic.BaseModel):
    ...
    created_by_actor: GetV2ObjectsObjectRecordsRecordIdAttributesAttributeValuesResponseDataItemTimestampCreatedByActor = pydantic.Field(
