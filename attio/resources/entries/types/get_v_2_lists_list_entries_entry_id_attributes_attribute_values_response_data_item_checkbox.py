...
class GetV2ListsListEntriesEntryIdAttributesAttributeValuesResponseDataItemCheckbox(pydantic.BaseModel):
    ...
    created_by_actor: GetV2ListsListEntriesEntryIdAttributesAttributeValuesResponseDataItemCheckboxCreatedByActor = (
