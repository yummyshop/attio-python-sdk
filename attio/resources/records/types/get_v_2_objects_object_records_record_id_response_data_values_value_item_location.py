...
class GetV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemLocation(pydantic.BaseModel):
    ...
    created_by_actor: GetV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemLocationCreatedByActor = (
