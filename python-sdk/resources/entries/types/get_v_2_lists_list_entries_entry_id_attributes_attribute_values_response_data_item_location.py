...
class GetV2ListsListEntriesEntryIdAttributesAttributeValuesResponseDataItemLocation(pydantic.BaseModel):
    ...
    created_by_actor: GetV2ListsListEntriesEntryIdAttributesAttributeValuesResponseDataItemLocationCreatedByActor = (
