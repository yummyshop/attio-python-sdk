...
class GetV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemNumber(pydantic.BaseModel):
    ...
    created_by_actor: GetV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemNumberCreatedByActor = pydantic.Field(
