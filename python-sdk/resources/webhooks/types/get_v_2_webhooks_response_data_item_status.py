...
class GetV2WebhooksResponseDataItemStatus(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is GetV2WebhooksResponseDataItemStatus.ACTIVE:
            return active()
        if self is GetV2WebhooksResponseDataItemStatus.DEGRADED:
            return degraded()
        if self is GetV2WebhooksResponseDataItemStatus.INACTIVE:
            return inactive()
