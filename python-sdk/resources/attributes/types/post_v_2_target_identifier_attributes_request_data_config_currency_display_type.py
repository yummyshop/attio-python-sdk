...
class PostV2TargetIdentifierAttributesRequestDataConfigCurrencyDisplayType(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is PostV2TargetIdentifierAttributesRequestDataConfigCurrencyDisplayType.CODE:
            return code()
        if self is PostV2TargetIdentifierAttributesRequestDataConfigCurrencyDisplayType.NAME:
            return name()
        if self is PostV2TargetIdentifierAttributesRequestDataConfigCurrencyDisplayType.NARROW_SYMBOL:
            return narrow_symbol()
        if self is PostV2TargetIdentifierAttributesRequestDataConfigCurrencyDisplayType.SYMBOL:
            return symbol()
