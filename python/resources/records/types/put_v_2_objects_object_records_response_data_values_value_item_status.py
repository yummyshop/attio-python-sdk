...
class PutV2ObjectsObjectRecordsResponseDataValuesValueItemStatus(pydantic.BaseModel):
    ...
    created_by_actor: PutV2ObjectsObjectRecordsResponseDataValuesValueItemStatusCreatedByActor = pydantic.Field(
