...
class PatchV2ListsListRequestDataWorkspaceAccess(str, enum.Enum):
    """
    ...
    def visit(
        ...
        if self is PatchV2ListsListRequestDataWorkspaceAccess.FULL_ACCESS:
            return full_access()
        if self is PatchV2ListsListRequestDataWorkspaceAccess.READ_AND_WRITE:
            return read_and_write()
        if self is PatchV2ListsListRequestDataWorkspaceAccess.READ_ONLY:
            return read_only()
