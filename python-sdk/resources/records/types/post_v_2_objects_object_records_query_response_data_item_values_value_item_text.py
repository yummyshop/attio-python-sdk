...
class PostV2ObjectsObjectRecordsQueryResponseDataItemValuesValueItemText(pydantic.BaseModel):
    ...
    created_by_actor: PostV2ObjectsObjectRecordsQueryResponseDataItemValuesValueItemTextCreatedByActor = pydantic.Field(
