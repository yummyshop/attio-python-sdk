...
class PostV2ObjectsObjectRecordsQueryResponseDataItemValuesValueItemNumber(pydantic.BaseModel):
    ...
    created_by_actor: PostV2ObjectsObjectRecordsQueryResponseDataItemValuesValueItemNumberCreatedByActor = (
