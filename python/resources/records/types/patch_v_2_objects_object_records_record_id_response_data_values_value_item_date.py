...
class PatchV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemDate(pydantic.BaseModel):
    ...
    created_by_actor: PatchV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemDateCreatedByActor = pydantic.Field(
