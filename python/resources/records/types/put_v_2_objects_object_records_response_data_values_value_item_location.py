...
class PutV2ObjectsObjectRecordsResponseDataValuesValueItemLocation(pydantic.BaseModel):
    ...
    created_by_actor: PutV2ObjectsObjectRecordsResponseDataValuesValueItemLocationCreatedByActor = pydantic.Field(
