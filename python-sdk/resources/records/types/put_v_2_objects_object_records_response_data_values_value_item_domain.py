...
class PutV2ObjectsObjectRecordsResponseDataValuesValueItemDomain(pydantic.BaseModel):
    ...
    created_by_actor: PutV2ObjectsObjectRecordsResponseDataValuesValueItemDomainCreatedByActor = pydantic.Field(
