...
class PostV2ObjectsObjectRecordsQueryResponseDataItemValuesValueItemTimestamp(pydantic.BaseModel):
    ...
    created_by_actor: PostV2ObjectsObjectRecordsQueryResponseDataItemValuesValueItemTimestampCreatedByActor = (
