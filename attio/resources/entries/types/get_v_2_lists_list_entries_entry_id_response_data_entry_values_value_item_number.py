...
class GetV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemNumber(pydantic.BaseModel):
    ...
    created_by_actor: GetV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemNumberCreatedByActor = pydantic.Field(
