...
class PutV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemPersonalName(pydantic.BaseModel):
    ...
    created_by_actor: PutV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemPersonalNameCreatedByActor = (
