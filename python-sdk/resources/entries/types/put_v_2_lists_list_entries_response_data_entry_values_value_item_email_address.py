...
class PutV2ListsListEntriesResponseDataEntryValuesValueItemEmailAddress(pydantic.BaseModel):
    ...
    created_by_actor: PutV2ListsListEntriesResponseDataEntryValuesValueItemEmailAddressCreatedByActor = pydantic.Field(
