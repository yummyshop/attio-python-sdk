...
class PostV2ListsListEntriesQueryResponseDataItemEntryValuesValueItemCheckbox(pydantic.BaseModel):
    ...
    created_by_actor: PostV2ListsListEntriesQueryResponseDataItemEntryValuesValueItemCheckboxCreatedByActor = (
