...
class PostV2ObjectsObjectRecordsQueryResponseDataItemValuesValueItemEmailAddress(pydantic.BaseModel):
    ...
    created_by_actor: PostV2ObjectsObjectRecordsQueryResponseDataItemValuesValueItemEmailAddressCreatedByActor = (
