...
class PostV2CommentsRequestDataAuthor(pydantic.BaseModel):
    ...
    author: PostV2CommentsRequestDataAuthorAuthor = pydantic.Field(
    ...
    entry: PostV2CommentsRequestDataAuthorEntry
