...
class PatchV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemRecordReference(pydantic.BaseModel):
    ...
    created_by_actor: PatchV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemRecordReferenceCreatedByActor = (
