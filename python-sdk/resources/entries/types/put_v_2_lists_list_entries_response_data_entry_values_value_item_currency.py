...
class PutV2ListsListEntriesResponseDataEntryValuesValueItemCurrency(pydantic.BaseModel):
    ...
    created_by_actor: PutV2ListsListEntriesResponseDataEntryValuesValueItemCurrencyCreatedByActor = pydantic.Field(
