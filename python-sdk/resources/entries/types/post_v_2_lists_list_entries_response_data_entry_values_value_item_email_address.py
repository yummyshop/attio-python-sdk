...
class PostV2ListsListEntriesResponseDataEntryValuesValueItemEmailAddress(pydantic.BaseModel):
    ...
    created_by_actor: PostV2ListsListEntriesResponseDataEntryValuesValueItemEmailAddressCreatedByActor = pydantic.Field(
