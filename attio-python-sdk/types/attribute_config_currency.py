...
class AttributeConfigCurrency(pydantic.BaseModel):
    """
    Configuration available for attributes of type "currency".
    """

    default_currency_code: typing.Optional[AttributeConfigCurrencyDefaultCurrencyCode] = pydantic.Field(
        description="The ISO4217 code representing the currency that values for this attribute should be stored in."
    )
    display_type: typing.Optional[AttributeConfigCurrencyDisplayType] = pydantic.Field(
