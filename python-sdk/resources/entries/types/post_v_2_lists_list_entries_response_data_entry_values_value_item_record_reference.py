...
class PostV2ListsListEntriesResponseDataEntryValuesValueItemRecordReference(pydantic.BaseModel):
    ...
    created_by_actor: PostV2ListsListEntriesResponseDataEntryValuesValueItemRecordReferenceCreatedByActor = (
