...
class PatchV2TargetIdentifierAttributesAttributeStatusesStatusRequestData(pydantic.BaseModel):
    title: typing.Optional[str] = pydantic.Field(description="The Title of the status")
