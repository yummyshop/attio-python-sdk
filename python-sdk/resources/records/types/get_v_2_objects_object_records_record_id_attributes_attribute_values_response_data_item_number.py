...
class GetV2ObjectsObjectRecordsRecordIdAttributesAttributeValuesResponseDataItemNumber(pydantic.BaseModel):
    ...
    created_by_actor: GetV2ObjectsObjectRecordsRecordIdAttributesAttributeValuesResponseDataItemNumberCreatedByActor = (
