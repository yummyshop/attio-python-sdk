...
class GetV2ListsListEntriesEntryIdAttributesAttributeValuesResponseDataItemPersonalName(pydantic.BaseModel):
    ...
    created_by_actor: GetV2ListsListEntriesEntryIdAttributesAttributeValuesResponseDataItemPersonalNameCreatedByActor = pydantic.Field(
