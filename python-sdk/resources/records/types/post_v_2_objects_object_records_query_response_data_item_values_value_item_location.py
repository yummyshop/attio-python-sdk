...
class PostV2ObjectsObjectRecordsQueryResponseDataItemValuesValueItemLocation(pydantic.BaseModel):
    ...
    created_by_actor: PostV2ObjectsObjectRecordsQueryResponseDataItemValuesValueItemLocationCreatedByActor = (
