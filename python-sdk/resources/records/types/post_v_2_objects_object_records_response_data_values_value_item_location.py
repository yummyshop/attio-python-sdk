...
class PostV2ObjectsObjectRecordsResponseDataValuesValueItemLocation(pydantic.BaseModel):
    ...
    created_by_actor: PostV2ObjectsObjectRecordsResponseDataValuesValueItemLocationCreatedByActor = pydantic.Field(
