...
class PutV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemNumber(pydantic.BaseModel):
    ...
    created_by_actor: PutV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemNumberCreatedByActor = pydantic.Field(
