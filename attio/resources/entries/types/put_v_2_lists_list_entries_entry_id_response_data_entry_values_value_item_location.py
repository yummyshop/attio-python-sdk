...
class PutV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemLocation(pydantic.BaseModel):
    ...
    created_by_actor: PutV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemLocationCreatedByActor = (
