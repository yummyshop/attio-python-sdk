...
class PutV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemEmailAddress(pydantic.BaseModel):
    ...
    created_by_actor: PutV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemEmailAddressCreatedByActor = (
