...
class PostV2ListsListEntriesQueryResponseDataItemEntryValuesValueItemText(pydantic.BaseModel):
    ...
    created_by_actor: PostV2ListsListEntriesQueryResponseDataItemEntryValuesValueItemTextCreatedByActor = (
