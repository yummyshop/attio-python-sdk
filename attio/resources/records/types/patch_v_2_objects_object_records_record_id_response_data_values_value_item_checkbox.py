...
class PatchV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemCheckbox(pydantic.BaseModel):
    ...
    created_by_actor: PatchV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemCheckboxCreatedByActor = (
