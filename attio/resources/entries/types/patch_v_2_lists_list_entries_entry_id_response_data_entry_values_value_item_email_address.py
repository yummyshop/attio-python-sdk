...
class PatchV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemEmailAddress(pydantic.BaseModel):
    ...
    created_by_actor: PatchV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemEmailAddressCreatedByActor = (
