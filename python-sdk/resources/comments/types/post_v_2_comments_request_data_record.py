...
class PostV2CommentsRequestDataRecord(pydantic.BaseModel):
    ...
    author: PostV2CommentsRequestDataRecordAuthor = pydantic.Field(
    ...
    record: PostV2CommentsRequestDataRecordRecord
