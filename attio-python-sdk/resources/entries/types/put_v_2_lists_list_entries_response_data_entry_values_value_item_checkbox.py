...
class PutV2ListsListEntriesResponseDataEntryValuesValueItemCheckbox(pydantic.BaseModel):
    ...
    created_by_actor: PutV2ListsListEntriesResponseDataEntryValuesValueItemCheckboxCreatedByActor = pydantic.Field(
