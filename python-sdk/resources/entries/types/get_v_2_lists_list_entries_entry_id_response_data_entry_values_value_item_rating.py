...
class GetV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemRating(pydantic.BaseModel):
    ...
    created_by_actor: GetV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemRatingCreatedByActor = pydantic.Field(
