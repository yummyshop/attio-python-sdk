...
class GetV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemDate(pydantic.BaseModel):
    ...
    created_by_actor: GetV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemDateCreatedByActor = pydantic.Field(
