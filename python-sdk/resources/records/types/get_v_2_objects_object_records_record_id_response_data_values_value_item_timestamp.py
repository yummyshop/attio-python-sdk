...
class GetV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemTimestamp(pydantic.BaseModel):
    ...
    created_by_actor: GetV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemTimestampCreatedByActor = (
