...
class GetV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemCurrency(pydantic.BaseModel):
    ...
    created_by_actor: GetV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemCurrencyCreatedByActor = (
