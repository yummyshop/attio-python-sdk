...
class PutV2ObjectsObjectRecordsResponseDataValuesValueItemDate(pydantic.BaseModel):
    ...
    created_by_actor: PutV2ObjectsObjectRecordsResponseDataValuesValueItemDateCreatedByActor = pydantic.Field(
