...
class PatchV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemRating(pydantic.BaseModel):
    ...
    created_by_actor: PatchV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemRatingCreatedByActor = (
