...
class GetV2ObjectsObjectRecordsRecordIdAttributesAttributeValuesResponseDataItemLocation(pydantic.BaseModel):
    ...
    created_by_actor: GetV2ObjectsObjectRecordsRecordIdAttributesAttributeValuesResponseDataItemLocationCreatedByActor = pydantic.Field(
