...
class PostV2ListsListEntriesQueryResponseDataItemEntryValuesValueItemRecordReference(pydantic.BaseModel):
    ...
    created_by_actor: PostV2ListsListEntriesQueryResponseDataItemEntryValuesValueItemRecordReferenceCreatedByActor = (
