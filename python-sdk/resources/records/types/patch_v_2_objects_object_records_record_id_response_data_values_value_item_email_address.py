...
class PatchV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemEmailAddress(pydantic.BaseModel):
    ...
    created_by_actor: PatchV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemEmailAddressCreatedByActor = (
