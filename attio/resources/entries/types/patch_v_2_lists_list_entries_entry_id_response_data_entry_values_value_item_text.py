...
class PatchV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemText(pydantic.BaseModel):
    ...
    created_by_actor: PatchV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemTextCreatedByActor = pydantic.Field(
