...
class PutV2ObjectsObjectRecordsResponseDataValuesValueItemCheckbox(pydantic.BaseModel):
    ...
    created_by_actor: PutV2ObjectsObjectRecordsResponseDataValuesValueItemCheckboxCreatedByActor = pydantic.Field(
