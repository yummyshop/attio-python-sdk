...
class PatchV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemTimestamp(pydantic.BaseModel):
    ...
    created_by_actor: PatchV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemTimestampCreatedByActor = (
