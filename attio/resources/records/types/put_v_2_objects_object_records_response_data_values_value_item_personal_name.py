...
class PutV2ObjectsObjectRecordsResponseDataValuesValueItemPersonalName(pydantic.BaseModel):
    ...
    created_by_actor: PutV2ObjectsObjectRecordsResponseDataValuesValueItemPersonalNameCreatedByActor = pydantic.Field(
