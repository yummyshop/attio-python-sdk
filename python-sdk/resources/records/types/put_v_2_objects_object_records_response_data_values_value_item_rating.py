...
class PutV2ObjectsObjectRecordsResponseDataValuesValueItemRating(pydantic.BaseModel):
    ...
    created_by_actor: PutV2ObjectsObjectRecordsResponseDataValuesValueItemRatingCreatedByActor = pydantic.Field(
