...
class GetV2ObjectsObjectRecordsRecordIdAttributesAttributeValuesResponseDataItemDate(pydantic.BaseModel):
    ...
    created_by_actor: GetV2ObjectsObjectRecordsRecordIdAttributesAttributeValuesResponseDataItemDateCreatedByActor = (
