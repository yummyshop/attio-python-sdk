...
class GetV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemLocation(pydantic.BaseModel):
    ...
    created_by_actor: GetV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemLocationCreatedByActor = (
