...
class GetV2ObjectsObjectRecordsRecordIdAttributesAttributeValuesResponseDataItemRating(pydantic.BaseModel):
    ...
    created_by_actor: GetV2ObjectsObjectRecordsRecordIdAttributesAttributeValuesResponseDataItemRatingCreatedByActor = (
