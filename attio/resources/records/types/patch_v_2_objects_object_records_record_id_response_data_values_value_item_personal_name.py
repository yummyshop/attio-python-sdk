...
class PatchV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemPersonalName(pydantic.BaseModel):
    ...
    created_by_actor: PatchV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemPersonalNameCreatedByActor = (
