...
class PatchV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemLocation(pydantic.BaseModel):
    ...
    created_by_actor: PatchV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemLocationCreatedByActor = (
