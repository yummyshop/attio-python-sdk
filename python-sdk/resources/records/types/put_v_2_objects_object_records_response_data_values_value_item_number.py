...
class PutV2ObjectsObjectRecordsResponseDataValuesValueItemNumber(pydantic.BaseModel):
    ...
    created_by_actor: PutV2ObjectsObjectRecordsResponseDataValuesValueItemNumberCreatedByActor = pydantic.Field(
