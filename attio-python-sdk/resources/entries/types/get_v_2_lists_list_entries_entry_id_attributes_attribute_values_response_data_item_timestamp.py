...
class GetV2ListsListEntriesEntryIdAttributesAttributeValuesResponseDataItemTimestamp(pydantic.BaseModel):
    ...
    created_by_actor: GetV2ListsListEntriesEntryIdAttributesAttributeValuesResponseDataItemTimestampCreatedByActor = (
