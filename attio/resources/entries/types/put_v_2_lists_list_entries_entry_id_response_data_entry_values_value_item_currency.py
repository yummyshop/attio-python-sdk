...
class PutV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemCurrency(pydantic.BaseModel):
    ...
    created_by_actor: PutV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemCurrencyCreatedByActor = (
