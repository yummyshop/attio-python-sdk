...
class PatchV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemDate(pydantic.BaseModel):
    ...
    created_by_actor: PatchV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemDateCreatedByActor = pydantic.Field(
