...
class PostV2ListsListEntriesResponseDataEntryValuesValueItemNumber(pydantic.BaseModel):
    ...
    created_by_actor: PostV2ListsListEntriesResponseDataEntryValuesValueItemNumberCreatedByActor = pydantic.Field(
