...
class PostV2ListsListEntriesQueryResponseDataItemEntryValuesValueItemLocation(pydantic.BaseModel):
    ...
    created_by_actor: PostV2ListsListEntriesQueryResponseDataItemEntryValuesValueItemLocationCreatedByActor = (
