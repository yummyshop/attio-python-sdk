...
class PostV2ListsListEntriesResponseDataEntryValuesValueItemCheckbox(pydantic.BaseModel):
    ...
    created_by_actor: PostV2ListsListEntriesResponseDataEntryValuesValueItemCheckboxCreatedByActor = pydantic.Field(
