...
class PutV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemRating(pydantic.BaseModel):
    ...
    created_by_actor: PutV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemRatingCreatedByActor = pydantic.Field(
