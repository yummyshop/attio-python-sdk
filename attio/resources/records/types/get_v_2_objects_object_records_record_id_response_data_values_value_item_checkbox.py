...
class GetV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemCheckbox(pydantic.BaseModel):
    ...
    created_by_actor: GetV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemCheckboxCreatedByActor = (
