...
class PostV2ObjectsObjectRecordsQueryResponseDataItemValuesValueItemRating(pydantic.BaseModel):
    ...
    created_by_actor: PostV2ObjectsObjectRecordsQueryResponseDataItemValuesValueItemRatingCreatedByActor = (
