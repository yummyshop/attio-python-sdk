...
class PatchV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemCurrency(pydantic.BaseModel):
    ...
    created_by_actor: PatchV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemCurrencyCreatedByActor = (
