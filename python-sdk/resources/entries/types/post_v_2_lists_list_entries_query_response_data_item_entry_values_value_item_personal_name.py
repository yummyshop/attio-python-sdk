...
class PostV2ListsListEntriesQueryResponseDataItemEntryValuesValueItemPersonalName(pydantic.BaseModel):
    ...
    created_by_actor: PostV2ListsListEntriesQueryResponseDataItemEntryValuesValueItemPersonalNameCreatedByActor = (
