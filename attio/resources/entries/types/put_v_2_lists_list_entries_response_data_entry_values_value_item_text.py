...
class PutV2ListsListEntriesResponseDataEntryValuesValueItemText(pydantic.BaseModel):
    ...
    created_by_actor: PutV2ListsListEntriesResponseDataEntryValuesValueItemTextCreatedByActor = pydantic.Field(
