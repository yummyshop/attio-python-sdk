...
class PatchV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemNumber(pydantic.BaseModel):
    ...
    created_by_actor: PatchV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemNumberCreatedByActor = (
