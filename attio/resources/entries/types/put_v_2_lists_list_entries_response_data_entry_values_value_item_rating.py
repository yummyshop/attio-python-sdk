...
class PutV2ListsListEntriesResponseDataEntryValuesValueItemRating(pydantic.BaseModel):
    ...
    created_by_actor: PutV2ListsListEntriesResponseDataEntryValuesValueItemRatingCreatedByActor = pydantic.Field(
