...
class PatchV2TargetIdentifierAttributesAttributeRequestDataConfigCurrency(pydantic.BaseModel):
    """
    Configuration available for attributes of type "currency".
    """

    default_currency_code: PatchV2TargetIdentifierAttributesAttributeRequestDataConfigCurrencyDefaultCurrencyCode = (
        pydantic.Field(
            description="The ISO4217 code representing the currency that values for this attribute should be stored in."
        )
    )
    display_type: PatchV2TargetIdentifierAttributesAttributeRequestDataConfigCurrencyDisplayType = pydantic.Field(
