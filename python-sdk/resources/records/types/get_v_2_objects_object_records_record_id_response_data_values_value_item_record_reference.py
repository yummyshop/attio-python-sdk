...
class GetV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemRecordReference(pydantic.BaseModel):
    ...
    created_by_actor: GetV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemRecordReferenceCreatedByActor = (
