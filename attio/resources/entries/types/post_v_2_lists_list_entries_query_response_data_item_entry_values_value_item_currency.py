...
class PostV2ListsListEntriesQueryResponseDataItemEntryValuesValueItemCurrency(pydantic.BaseModel):
    ...
    created_by_actor: PostV2ListsListEntriesQueryResponseDataItemEntryValuesValueItemCurrencyCreatedByActor = (
