...
class GetV2ObjectsObjectRecordsRecordIdAttributesAttributeValuesResponseDataItemPersonalName(pydantic.BaseModel):
    ...
    created_by_actor: GetV2ObjectsObjectRecordsRecordIdAttributesAttributeValuesResponseDataItemPersonalNameCreatedByActor = pydantic.Field(
