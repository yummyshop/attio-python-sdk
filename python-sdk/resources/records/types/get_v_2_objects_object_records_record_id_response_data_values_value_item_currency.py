...
class GetV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemCurrency(pydantic.BaseModel):
    ...
    created_by_actor: GetV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemCurrencyCreatedByActor = (
