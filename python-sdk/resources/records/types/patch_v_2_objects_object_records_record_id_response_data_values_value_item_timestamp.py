...
class PatchV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemTimestamp(pydantic.BaseModel):
    ...
    created_by_actor: PatchV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemTimestampCreatedByActor = (
