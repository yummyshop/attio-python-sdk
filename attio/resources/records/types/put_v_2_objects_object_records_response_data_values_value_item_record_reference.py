...
class PutV2ObjectsObjectRecordsResponseDataValuesValueItemRecordReference(pydantic.BaseModel):
    ...
    created_by_actor: PutV2ObjectsObjectRecordsResponseDataValuesValueItemRecordReferenceCreatedByActor = (
