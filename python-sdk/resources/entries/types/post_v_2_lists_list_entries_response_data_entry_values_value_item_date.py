...
class PostV2ListsListEntriesResponseDataEntryValuesValueItemDate(pydantic.BaseModel):
    ...
    created_by_actor: PostV2ListsListEntriesResponseDataEntryValuesValueItemDateCreatedByActor = pydantic.Field(
