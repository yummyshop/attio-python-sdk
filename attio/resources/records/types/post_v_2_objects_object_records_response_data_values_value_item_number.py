...
class PostV2ObjectsObjectRecordsResponseDataValuesValueItemNumber(pydantic.BaseModel):
    ...
    created_by_actor: PostV2ObjectsObjectRecordsResponseDataValuesValueItemNumberCreatedByActor = pydantic.Field(
