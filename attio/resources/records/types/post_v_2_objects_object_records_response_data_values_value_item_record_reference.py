...
class PostV2ObjectsObjectRecordsResponseDataValuesValueItemRecordReference(pydantic.BaseModel):
    ...
    created_by_actor: PostV2ObjectsObjectRecordsResponseDataValuesValueItemRecordReferenceCreatedByActor = (
