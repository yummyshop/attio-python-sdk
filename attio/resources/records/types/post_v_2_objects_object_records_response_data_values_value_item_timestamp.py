...
class PostV2ObjectsObjectRecordsResponseDataValuesValueItemTimestamp(pydantic.BaseModel):
    ...
    created_by_actor: PostV2ObjectsObjectRecordsResponseDataValuesValueItemTimestampCreatedByActor = pydantic.Field(
