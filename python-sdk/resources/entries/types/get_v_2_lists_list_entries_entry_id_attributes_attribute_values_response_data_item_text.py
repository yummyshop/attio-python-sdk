...
class GetV2ListsListEntriesEntryIdAttributesAttributeValuesResponseDataItemText(pydantic.BaseModel):
    ...
    created_by_actor: GetV2ListsListEntriesEntryIdAttributesAttributeValuesResponseDataItemTextCreatedByActor = (
