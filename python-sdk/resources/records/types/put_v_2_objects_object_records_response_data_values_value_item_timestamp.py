...
class PutV2ObjectsObjectRecordsResponseDataValuesValueItemTimestamp(pydantic.BaseModel):
    ...
    created_by_actor: PutV2ObjectsObjectRecordsResponseDataValuesValueItemTimestampCreatedByActor = pydantic.Field(
