...
class GetV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemTimestamp(pydantic.BaseModel):
    ...
    created_by_actor: GetV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemTimestampCreatedByActor = (
