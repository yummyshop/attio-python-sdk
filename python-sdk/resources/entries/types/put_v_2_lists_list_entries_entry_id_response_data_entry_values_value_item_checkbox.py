...
class PutV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemCheckbox(pydantic.BaseModel):
    ...
    created_by_actor: PutV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemCheckboxCreatedByActor = (
