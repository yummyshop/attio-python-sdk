...
class PatchV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemNumber(pydantic.BaseModel):
    ...
    created_by_actor: PatchV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemNumberCreatedByActor = (
