...
class GetV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemRating(pydantic.BaseModel):
    ...
    created_by_actor: GetV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemRatingCreatedByActor = pydantic.Field(
