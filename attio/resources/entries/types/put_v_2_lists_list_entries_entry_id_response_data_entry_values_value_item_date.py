...
class PutV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemDate(pydantic.BaseModel):
    ...
    created_by_actor: PutV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemDateCreatedByActor = pydantic.Field(
