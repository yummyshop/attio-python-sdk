...
class PutV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemRecordReference(pydantic.BaseModel):
    ...
    created_by_actor: PutV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemRecordReferenceCreatedByActor = (
