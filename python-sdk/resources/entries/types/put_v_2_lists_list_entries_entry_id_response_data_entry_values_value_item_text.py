...
class PutV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemText(pydantic.BaseModel):
    ...
    created_by_actor: PutV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemTextCreatedByActor = pydantic.Field(
