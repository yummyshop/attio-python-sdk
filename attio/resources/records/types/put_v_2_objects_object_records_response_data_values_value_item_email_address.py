...
class PutV2ObjectsObjectRecordsResponseDataValuesValueItemEmailAddress(pydantic.BaseModel):
    ...
    created_by_actor: PutV2ObjectsObjectRecordsResponseDataValuesValueItemEmailAddressCreatedByActor = pydantic.Field(
