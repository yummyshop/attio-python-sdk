...
class PostV2ListsListEntriesResponseDataEntryValuesValueItemText(pydantic.BaseModel):
    ...
    created_by_actor: PostV2ListsListEntriesResponseDataEntryValuesValueItemTextCreatedByActor = pydantic.Field(
