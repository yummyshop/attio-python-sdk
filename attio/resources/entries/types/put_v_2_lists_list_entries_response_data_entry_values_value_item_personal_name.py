...
class PutV2ListsListEntriesResponseDataEntryValuesValueItemPersonalName(pydantic.BaseModel):
    ...
    created_by_actor: PutV2ListsListEntriesResponseDataEntryValuesValueItemPersonalNameCreatedByActor = pydantic.Field(
