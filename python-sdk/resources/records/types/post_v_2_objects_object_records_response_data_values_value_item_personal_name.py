...
class PostV2ObjectsObjectRecordsResponseDataValuesValueItemPersonalName(pydantic.BaseModel):
    ...
    created_by_actor: PostV2ObjectsObjectRecordsResponseDataValuesValueItemPersonalNameCreatedByActor = pydantic.Field(
