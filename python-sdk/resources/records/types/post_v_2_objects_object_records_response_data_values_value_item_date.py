...
class PostV2ObjectsObjectRecordsResponseDataValuesValueItemDate(pydantic.BaseModel):
    ...
    created_by_actor: PostV2ObjectsObjectRecordsResponseDataValuesValueItemDateCreatedByActor = pydantic.Field(
