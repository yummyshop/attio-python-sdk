...
class PostV2ListsListEntriesResponseDataEntryValuesValueItemPersonalName(pydantic.BaseModel):
    ...
    created_by_actor: PostV2ListsListEntriesResponseDataEntryValuesValueItemPersonalNameCreatedByActor = pydantic.Field(
