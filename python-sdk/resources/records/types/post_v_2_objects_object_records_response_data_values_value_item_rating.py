...
class PostV2ObjectsObjectRecordsResponseDataValuesValueItemRating(pydantic.BaseModel):
    ...
    created_by_actor: PostV2ObjectsObjectRecordsResponseDataValuesValueItemRatingCreatedByActor = pydantic.Field(
