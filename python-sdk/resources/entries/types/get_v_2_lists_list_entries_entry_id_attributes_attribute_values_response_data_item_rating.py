...
class GetV2ListsListEntriesEntryIdAttributesAttributeValuesResponseDataItemRating(pydantic.BaseModel):
    ...
    created_by_actor: GetV2ListsListEntriesEntryIdAttributesAttributeValuesResponseDataItemRatingCreatedByActor = (
