...
class GetV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemText(pydantic.BaseModel):
    ...
    created_by_actor: GetV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemTextCreatedByActor = pydantic.Field(
