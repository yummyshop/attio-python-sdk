...
class GetV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemText(pydantic.BaseModel):
    ...
    created_by_actor: GetV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemTextCreatedByActor = pydantic.Field(
