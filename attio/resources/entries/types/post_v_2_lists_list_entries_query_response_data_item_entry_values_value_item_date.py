...
class PostV2ListsListEntriesQueryResponseDataItemEntryValuesValueItemDate(pydantic.BaseModel):
    ...
    created_by_actor: PostV2ListsListEntriesQueryResponseDataItemEntryValuesValueItemDateCreatedByActor = (
