...
class PatchV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemText(pydantic.BaseModel):
    ...
    created_by_actor: PatchV2ObjectsObjectRecordsRecordIdResponseDataValuesValueItemTextCreatedByActor = pydantic.Field(
