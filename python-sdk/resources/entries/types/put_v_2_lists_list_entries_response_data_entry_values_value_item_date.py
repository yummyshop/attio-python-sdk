...
class PutV2ListsListEntriesResponseDataEntryValuesValueItemDate(pydantic.BaseModel):
    ...
    created_by_actor: PutV2ListsListEntriesResponseDataEntryValuesValueItemDateCreatedByActor = pydantic.Field(
