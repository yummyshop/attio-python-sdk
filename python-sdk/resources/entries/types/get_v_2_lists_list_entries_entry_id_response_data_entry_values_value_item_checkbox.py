...
class GetV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemCheckbox(pydantic.BaseModel):
    ...
    created_by_actor: GetV2ListsListEntriesEntryIdResponseDataEntryValuesValueItemCheckboxCreatedByActor = (
